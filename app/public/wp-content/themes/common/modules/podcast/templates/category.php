    ...
    <div class="container front-grid">
        <div class="row posts-container">
            <div class="col-xs-12">
                <div class="row">
                    <?php $counter = 0; ?>
                    <?php while (itera_have_posts() && $counter < 1): the_post(); $counter++; ?>
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="row">
                            <?php $counter = 0; ?>
                            <?php while (itera_have_posts() && $counter < 2): the_post(); $counter++; ?>
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <?php module_template('theme/article/small'); ?>
                                </div>
                                <?php if($counter == 1): ?>
                                    <div class="clearfix visible-xs"></div>
                                    <div class="ad-nexus-ad visible-xs" data-id="sysla-wph-front-board-1"></div>
                                <?php endif; ?>
                            <?php endwhile; ?>
                        </div>
                    </div>
                    ...
                    <?php $counter = 0; ?>
                    <?php while(itera_have_posts() && $counter < 6): $counter++; ?>
                    ...
                    <div class="ad-nexus-ad visible-xs" data-id="sysla-wph-front-board-2"></div>
