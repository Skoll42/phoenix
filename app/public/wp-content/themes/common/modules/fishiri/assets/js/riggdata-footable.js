    ...
    $FOOTABLE.init = function() {
        ...
        function getSelectedFilters() {
            return {
                ...
                status: getFilter('#statusFilter option:selected'),
                owner: getFilter('#ownerFilter option:selected'),
                operator: getFilter('#operatorFilter option:selected'),
                type: getFilter('#typeFilter option:selected'),
                sector: getFilter('#sectorFilter option:selected')
            };
        }
        ...
        $(function () {
            $('.footable').footable({ breakpoints: { phone:480, portrait:768, landscape:992, tablet:1024 }, filter: {
